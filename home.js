...
// console.log(canWeDeliver(34714))
...
// console.log(canWeDeliverTwo(deliveryAreaZipCodes, 347174))
...
let dealExtension = deals[1].desc.replace('March', 'April').trim()
console.log(dealExtension)
